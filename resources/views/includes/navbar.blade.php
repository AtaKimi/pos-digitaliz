    ...
    <div class="flex align-middle">
        ...
        <div class="mr-5 ">
            <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
                class="flex align-middle items-center gap-2 focus:ring-4 focus:outline-none focus:ring-blue-300 " type="button">
                <span class="my-auto mr-2 font-medium @if (request()->routeIs('tenant-*')) text-white-50 @endif">Anya
                    Forger</span>
                <img class="rounded-full w-10 h-10" src="{{ asset('assets/img/anya-profile.png') }}" alt="">
                <svg width="15" height="15" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg" class="@if (request()->routeIs('tenant-*')) fill-white-50 @else fill-black-400 @endif">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M1.02903 2.90403C1.15107 2.78199 1.34893 2.78199 1.47097 2.90403L5 6.43306L8.52903 2.90403C8.65107 2.78199 8.84893 2.78199 8.97097 2.90403C9.09301 3.02607 9.09301 3.22393 8.97097 3.34597L5.22097 7.09597C5.09893 7.21801 4.90107 7.21801 4.77903 7.09597L1.02903 3.34597C0.90699 3.22393 0.90699 3.02607 1.02903 2.90403Z" />
                    </svg>
