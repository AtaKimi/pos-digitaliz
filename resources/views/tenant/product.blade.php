                ...
                <div class="flex gap-4">
                    ...
                    <button class="flex items-center p-3 border-2 rounded-lg gap-2" data-modal-target="modal-add-category"
                        ...
                        <svg width="25" height="26" viewBox="0 0 25 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M9.375 16.9062C9.375 16.4748 9.72478 16.125 10.1562 16.125H14.8438C15.2752 16.125 15.625 16.4748 15.625 16.9062C15.625 17.3377 15.2752 17.6875 14.8438 17.6875H10.1562C9.72478 17.6875 9.375 17.3377 9.375 16.9062Z" fill="#2E2E2E"/>
                            <path d="M6.25 12.2188C6.25 11.7873 6.59978 11.4375 7.03125 11.4375H17.9688C18.4002 11.4375 18.75 11.7873 18.75 12.2188C18.75 12.6502 18.4002 13 17.9688 13H7.03125C6.59978 13 6.25 12.6502 6.25 12.2188Z" fill="#2E2E2E"/>
                            <path d="M3.125 7.53125C3.125 7.09978 3.47478 6.75 3.90625 6.75H21.0938C21.5252 6.75 21.875 7.09978 21.875 7.53125C21.875 7.96272 21.5252 8.3125 21.0938 8.3125H3.90625C3.47478 8.3125 3.125 7.96272 3.125 7.53125Z" fill="#2E2E2E"/>
                        </svg>
                ...
                <div class="flex flex-col bg-white-50 flex-wrap rounded-lg w-[550px] border-2">
                    <div class="flex gap-x-6 p-6 ">
                        ...
                        <div class="text-gray-500">
                            ...
                            <p class="mb-2"> <span class="text-base font-bold">Category : </span> Daging</p>
