                            ...
                            <div class="relative w-full max-w-md max-h-full">
                                <div class="flex flex-col gap-10 relative bg-white-50 rounded-xl shadow p-10 w-[500px]">
                                    ...
                                    <div class="flex grid-cols-2 gap-3">
                                        <button
                                            class="w-full py-2 font-bold rounded-lg hover:border-2 hover:border-black-400" type="button" data-modal-hide="modal-edit-category-{{$category->id}}">Batalkan</button>
                                        <button class="w-full py-2 font-bold bg-red-600 rounded-lg text-white-50" type="submit">Konfirmasi</button>
                                    </div>
                                </form>
                                </div>
                            </div>
                        ...
                        class="fixed top-0 left-0 right-0 z-50 hidden p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                            <div class="relative w-full max-w-md max-h-full">
                                ...
                                <div class="flex flex-col gap-10 relative bg-white-50 rounded-xl shadow p-10 w-[500px]">
                                        ...
                                        <p class="text-center text-gray-500">Apakah Anda yakin ingin menghapus kategori ini?</p>
                                        <div class="flex grid-cols-2 gap-3">
                                            <button
                                                class="w-full py-2 font-bold rounded-lg hover:border-2 hover:border-black-400" data-modal-hide="modal-delete-category-{{$category->id}}">Batalkan</button>
                                            <button class="w-full py-2 font-bold bg-red-500 rounded-lg text-white-50" type="submit">Hapus</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
        ...
        <div id="modal-add-category" tabindex="-1"
            ...
            <div class="relative w-full max-w-md max-h-full">
                <div class="flex flex-col gap-10 relative bg-white-50 rounded-xl shadow p-10 w-[500px]">
                    ...
                    <div class="flex grid-cols-2 gap-3">
                        <button type="reset"
                            class="w-full py-2 font-bold rounded-lg hover:border-2 hover:border-black-400" data-modal-target="modal-add-category"
                            data-modal-hide="modal-add-category">Batalkan</button>
                        <button type="submit" class="w-full py-2 font-bold bg-red-500 rounded-lg text-white-50">Konfirmasi</button>
                    </div>
                    </form>
                </div>
            </div>
