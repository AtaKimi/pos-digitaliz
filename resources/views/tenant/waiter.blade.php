        ...
        <div class="flex items-center justify-between py-5 px-2">
            ...
            <div class="relative flex flex-row">
                ...
                <div class="flex items-center px-3 text-white-50">
                    <button type="button"
                        class="px-3 py-2 text-sm font-medium text-center inline-flex items-center text-white bg-red-500 rounded-lg hover:bg-red-600 focus:ring-2 focus:outline-none focus:ring-red-300"
                        data-modal-target="authentication-modal" data-modal-toggle="authentication-modal">
                        <svg width="18" height="18" viewBox="3 0 18 18" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                    ...
                    @forelse ($waiters as $waiter)
                        <tr class="bg-white-50 border-b hover:bg-gray-50">
                            ...
                            <th scope="row" class="px-4 py-4 font-medium text-gray-900 whitespace-nowrap">
                                <div class="flex items-center">
                                    <p class="">{{ $waiter->user->name }}</p>
                                </div>
                            </th>
                            <td class="px-4 py-4">
                                <div class="flex items-center">
                                    <p class="text-gray-900">{{ $waiter->user->email }}</p>
                                </div>
                            </td>
                            <td class="px-4 py-4">
                                <div class="flex items-center">
                                    <p class="text-gray-900 text-xs">{{ $waiter->user->phone_number }}</p>
                                </div>
                            </td>
                            <td class="px-8 py-4">
                                <p
                                    class="w-full bg-green-100 text-green-800 text-xs font-semibold mr-2 py-0.5 rounded-full text-center">
                                    Verified</p>
                            </td>
                            <td class="px-4 py-4">
            ...
            <nav class="flex items-center pt-4 py-2 px-2" aria-label="Table navigation">
                ...
                <div class="flex ml-10">
                    ...
                    <ul class="inline-flex -space-x-px text-xs">
                        <li>
                            <a href="#"
                                class="flex items-center justify-center px-3 mr-1 h-8 text-white-50 bg-red-500 border border-grey-200 hover:bg-gray-100 hover:text-grey-700 rounded-xl">1</a>
                        </li>
                        <li>
                            <a href="#"
            ...
            <div class="relative w-50 max-w-md max-h-full bg-white-50 rounded-xl">
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="p-6 text-center">
                        ...
                        <h3 class="mb-5 text-sm font-normal text-gray-500">Apakah Anda yakin ingin menghapus tenant ini?
                        </h3>
