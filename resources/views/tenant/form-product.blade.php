    ...
    <div class="w-full bg-white-200 rounded-xl p-8 mb-8">
        ...
        <div class="flex flex-col md:flex-row justify-between gap-6 mb-6">
            <div class="flex flex-col gap-4 border border-gray-400 bg-white-50 rounded-xl p-8 w-full">
                    ...
                    <label for="dropzone-file"
                        ...
                        <div class="flex flex-col items-center justify-center pt-5 pb-6 gap-4">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <p class="text-sm">
                                    Drop your files here. Or <span class="text-blue-500 font-bold">Click to Browse</span>
                                </p>
                            </div>
                        </div>
                ...
                <div class="bg-white-50 rounded-xl p-3 flex justify-between items-center border border-gray-300">
                    <div class="flex items-center gap-4">
                        <img src="{{ asset('assets/img/anya-profile.png') }}" alt="" class="w-10 h-10 rounded-lg">
                        <div>
                            <p class="text-sm font-bold">SotoBanjar01.jpg</p>
            ...
            <div class="border border-gray-400 bg-white-50 rounded-xl p-8 w-full">
                ...
                <div class="mb-2">
                    <label for="countries" class="block mb-2 font-bold text-gray-900 ">Choose category</label>
                    <select id="countries"
        ...
        <div class="flex gap-4 justify-end">
            ...
            <div>
                <button class="w-48 h-14 border bg-red-500 rounded-xl text-white-50 text-sm font-semibold tracking-widest">
