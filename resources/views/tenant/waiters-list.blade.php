            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    <tr class="bg-white-50 border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-8 py-4">
                            <p class="w-full bg-green-100 text-green-800 text-xs font-semibold mr-2 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300 text-center">Verified</p>
                        </td>
                        <td class="px-4 py-4">
                    ...
                    <tr class="bg-white-50 border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-8 py-4">
                            <p class="w-full bg-red-200 text-red-800 text-xs font-semibold mr-2 py-0.5 rounded-full dark:bg-red-900 dark:text-red-300 text-center">Unverified</p>
                        </td>
                        <td class="px-4 py-4">
                            <div class="flex justify-center">
                                <label class="relative inline-flex cursor-pointer">
            ...
            <nav class="flex items-center pt-4 py-2 px-2" aria-label="Table navigation">
                ...
                <div class="flex ml-10">
                    ...
                    <ul class="inline-flex -space-x-px text-xs">
                        <li>
                          <a href="#" class="flex items-center justify-center px-3 mr-1 h-8 text-white-50 bg-red-500 border border-grey-200 hover:bg-gray-100 hover:text-grey-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white rounded-xl">1</a>
                        </li>
                        <li>
        ...
        <div class="relative w-50 max-w-md max-h-full bg-white-50 rounded-xl">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                  <svg width="60" height="60" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" class="mx-auto mb-4 text-gray-400 w-15 h-15 dark:text-gray-200">
                    ...
                    <h3 class="mb-5 text-sm font-normal text-gray-500 dark:text-gray-400">Apakah Anda yakin ingin menghapus tenant ini?</h3>
                    ...
                    <button data-modal-hide="popup-modal" type="button" class="text-white-50 bg-red-500 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-700 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                      Hapus
                  </button>
                </div>
            </div>
      ...
      <div class="relative w-full max-w-md max-h-full">
          ...
          <div class="relative bg-white-50 rounded-lg shadow dark:bg-gray-700">
              ...
              <div class="px-6 py-6 lg:px-8">
                  ...
                  <label class="block mb-2 text-base font- dark:text-white uppercase">Data Waiters</label>
                  <form class="space-y-6" action="#">
                      <div>
                          <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Name</label>
                          <input type="" name="name" id="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Name" required>
                      </div>
                      <div>
                        <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email</label>
                        <input type="" name="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="name@gmail.com" required>
                      </div>
                      <div>
                        <label for="number" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Phone Number</label>
                        <input type="" name="number" id="number" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Phone number" required>
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <input type="password" name="confirm" id="confirm" placeholder="Confirm Password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" required>
                      </div>
