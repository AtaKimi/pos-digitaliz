...
@section('content')
    ...
    <x-card class="mb-5 overflow-x-auto">
        ...
        <div class="relative mb-24 min-w-[650px]" >
            <div class="absolute -top-3 w-full">
                <div class="flex justify-between">
                    ...
                    <div class="flex flex-col items-center  gap-2">
                        ...
                        <div
                            class="py-1 px-8 rounded-2xl 
                        @if (intval($order->status) > App\Enums\OrderStatus::COOKING) bg-violet-300 text-violet-900
                        @else
                        bg-grey-200 text-grey-700 @endif">
                            <p class="text-xs font-semibold">Serving</p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col items-center  gap-2">
                        ...
                        @else
                        bg-grey-200 text-grey-700 @endif">
                            <p class=" text-xs font-semibold">Done</p>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col items-center  gap-2">
                        ...
                        <div
                            class="py-1 px-8 rounded-2xl
                        @if ($order->status != App\Enums\OrderStatus::CANCELED) bg-grey-200 text-gray-600
                        @else
                            bg-red-500 text-white-50 @endif ">
                            <p class="text-xs font-semibold">Cancel</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="w-4/5 rounded-full h-2.5 ps-12 pr-16">
                <div class="bg-gray-200 rounded-full h-2.5">
                    ...
                    @elseif($order->status == App\Enums\OrderStatus::COOKING) width: 33.33%; 
                    @elseif($order->status == App\Enums\OrderStatus::SERVING) width: 66.66%; 
                    @elseif($order->status == App\Enums\OrderStatus::DONE) width: 100%; 
                    @elseif($order->status == App\Enums\OrderStatus::CANCELED) width: 100%; background-color: red; @endif">
                    </div>
                </div>
            </div>
        </div>
