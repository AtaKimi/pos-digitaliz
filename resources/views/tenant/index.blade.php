        ...
        <div class="flex flex-col gap-5 md:flex-row">
            ...
            <x-card class="w-full flex flex-col gap-6">
                <div class="flex items-center gap-5 p-1 rounded-full bg-yellow-50 w-full">
                    ...
                    <p class="text-md font-medium text-black text-start">Total Pendapatan Order</p>
                </div>
                <div>
            ...
            <x-card class="w-full flex flex-col gap-6">
                <div class="flex items-center gap-5 p-1 rounded-full bg-green-200 w-full">
                    ...
                    <span class="font-medium text-md text-black">Total Product</span>
                </div>
                <div>
                    <p class="text-2xl font-bold text-gray-900 pl-3">{{ $totalProduct }} Products</p>
                    {{-- <div class="flex items-center gap-1">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="7" height="7" viewBox="0 0 12 11"
                                fill="none">
