          ...
          <div class="w-full bg-white rounded-lg shadow dark:bg-gray-800">
            <div class="flex justify-between p-4 md:p-6 pb-0 md:pb-0">
              <div>
                ...
                <h5 class="leading-none text-2xl font-bold text-gray-900 dark:text-white pb-2">Total Pendapatan Order</h5>
              </div>
              <div
          ...
          <div class="w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
            <div class="flex justify-between border-gray-200 border-b dark:border-gray-700 pb-3">
              <dl>
                ...
                <dd class="leading-none text-2xl font-bold text-gray-900 dark:text-white">Total Product by Category</dd>
              </dl>
              <div>
