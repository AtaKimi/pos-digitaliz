    ...
    <div class="mb-5 overflow-hidden shadow-lg rounded-2xl bg-white-50">
        <div class="p-4">
            <div class="flex items-center">
                <div class="p-5 mr-4 bg-red-100 rounded-xl">
                    <!-- Icon di sini -->
        ...
        <div class="flex items-center justify-between px-2 py-5">
            ...
            <div class="relative flex flex-row">
                ...
                <div class="flex items-center px-3 text-white-50">
                    <button type="button"
                        class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-red-500 rounded-lg hover:bg-red-600 focus:ring-2 focus:outline-none focus:ring-red-300"
                ...
                <tbody>
                    @forelse ($users as $user)
                        <tr class="border-b bg-white-50 hover:bg-gray-50">
                            ...
                            <td class="px-4 py-4">
                                <div class="flex items-center">
                                    <p class="text-xs text-gray-900">{{ $user->phone_number }}</p>
                                </div>
                            </td>
                            <td class="px-8 py-4">
                                <p
                                    class="w-full {{ $user->email_verified_at ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }} text-xs font-semibold mr-2 py-0.5 rounded-full text-center">
                                    {{ $user->email_verified_at ? 'Verified' : 'Not Verified' }}</p>
                            </td>
                            <td class="px-4 py-4">
                                <div class="flex justify-center">
                                    <label class="relative inline-flex cursor-pointer">
                                        <input type="checkbox" value="" id="waiter-id"
                                            class="sr-only peer toggle-checkbox" {{ $user->waiter->is_active ? '' : 'checked' }}
                                            data-waiter-id="{{ $user->waiter->id }}">
