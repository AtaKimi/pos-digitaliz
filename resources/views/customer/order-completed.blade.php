    ...
    <div class="flex flex-col gap-5 items-center justify-center pb-5 py-5 px-8">
        ...
        <div class="flex items-center justify-center w-32 h-32 border border-red-500 rounded-full bg-gray-50">
            <svg width="82" height="60" viewBox="0 0 90 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M28 54.2399L9.49334 35.7333C8.49612 34.736 7.14361 34.1758 5.73334 34.1758C4.32306 34.1758 2.97055 34.736 1.97334 35.7333C0.976122 36.7305 0.415894 38.083 0.415894 39.4933C0.415894 40.1916 0.553434 40.883 0.820661 41.5281C1.08789 42.1733 1.47957 42.7595 1.97334 43.2533L24.2667 65.5466C26.3467 67.6266 29.7067 67.6266 31.7867 65.5466L88.2133 9.11992C89.2105 8.12271 89.7708 6.7702 89.7708 5.35992C89.7708 3.94965 89.2105 2.59714 88.2133 1.59992C87.2161 0.602711 85.8636 0.0424805 84.4533 0.0424805C83.0431 0.0424805 81.6905 0.602711 80.6933 1.59992L28 54.2399Z"
                    fill="#F54748" />
            </svg>
        </div>
        <p class=" font-medium text-center">Your order is verified!</p>
        <p class="font-medium text-center">Our team is cooking your food and serving it on your table as fast as we can!</p>

        <p class="text-gray-500">Want to order another menu?</p>
        <a class="block" href="{{route('customer-menu', [$tenant->id, $desk->id])}}">
            <button type="button"
                class="text-white-50 bg-red-500 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg px-8 py-2.5 text-center inline-flex items-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
