...
@section('content')
    {{-- table --}}
    <div class="relative overflow-x-auto shadow-md rounded-xl bg-white-100 m-10">
        ...
        <table class="w-full text-sm text-left text-gray-500">
            ...
            <tbody>
                ...
                <tr class="bg-white-50 border-b hover:bg-gray-100">
        ...
        <div class="flex justify-around items-center">
            <p class="text-xs justify-center hidden md:flex">
