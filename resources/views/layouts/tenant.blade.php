...
<body class="bg-bgGray-100">
    <div class="bg-primaryRed-100 h-64 w-full p-8 flex" style="background-size: 100% 400px">
        {{-- -------------------------------- side bar start ----------------------------------------------- --}}
        <div class="col-span-1 bg-white rounded-3xl mr-10" style="height: 900px">
            ...
            <a class="flex p-5 mx-5 bg-amber-400 nav-link rounded-xl align-middle w-64 {{ Route::currentRouteName() == 'tenant-index' ? 'bg-primaryRed-100 text-white' : '' }}"  href="{{ route('tenant-index') }}">
            ...
            <a class="flex p-5 mx-5 bg-amber-400 nav-link rounded-xl align-middle w-64 {{ Route::currentRouteName() == 'tenant' ? 'bg-primaryRed-100 text-white my-5' : '' }}"  href="#">
                <div class="flex items-center">
                    <div class="my-auto mr-5">
                ...
                <div class="flex align-middle">
                    ...
                    <div class="mr-5 ">
                        <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown"
                            class="flex focus:ring-4 focus:outline-none focus:ring-blue-300 " type="button"><span
                                class="mr-2 text-sm font-medium">Anya
                                Forger</span><img class="rounded-full w-6 h-6"
                                src="{{ asset('assets/img/anya-profile.png') }}" alt=""> <svg
                                class="w-2.5 h-2.5 ml-2.5 my-auto" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
