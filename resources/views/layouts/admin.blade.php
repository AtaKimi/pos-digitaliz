...
<body class="bg-slate-50">
    <div class="bg-amber-200 h-64 w-full p-8 flex" style="background-size: 100% 400px">
        {{-- -------------------------------- side bar start ----------------------------------------------- --}}
        <div class="col-span-1 bg-white rounded-3xl mr-10" style="height: 900px">
            ...
            <div class="flex p-5 mx-5 bg-amber-400 rounded-xl align-middle w-64">
                ...
                <p class="my-auto text-sm">Dashboard</p>
            </div>
            <div class="flex p-5 mx-5 rounded-xl align-middle">
                <div class="my-auto mr-5">
                ...
                <p class="my-auto text-sm">Tenant Management</p>
            </div>
        </div>
        {{-- -------------------------------- side bar end ----------------------------------------------- --}}
