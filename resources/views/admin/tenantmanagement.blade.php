    ...
    <div class="p-2 bg-white-50 border border-gray-200 rounded-3xl shadow dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-2xl">
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                    <tr
                        class="bg-white-50 border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        <td class="w-4 p-4">
                            <div class="flex items-center">
                                1
                            </div>
                        ...
                        <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                            <div class="flex items-center">
                                <div class="">
                                    <!-- kode di sini -->
                                    <p class="text-gray-500 text-xs">#12345</p>
                                    <!-- nama di sini -->
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                <img class="w-8 h-8 rounded-full mr-1" src="{{ url('assets/img/anya-profile.png') }}"
                                    alt="Rounded avatar">
                                <div>
                                    <!-- Title di sini -->
                        ...
                        <td class="px-6 py-4">
                            <p
                                class="w-30 bg-red-200 text-red-800 text-xs font-medium mr-2 py-0.5 rounded-full dark:bg-red-900 dark:text-red-300 text-center">
                                Belum bayar</p>
                        </td>
                        <td class="px-6 py-4">
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <p
                                class="w-30 bg-green-100 text-green-800 text-xs font-medium mr-2 py-0.5 rounded-full dark:bg-green-900 dark:text-green-300 text-center">
                                Lunas</p>
                        </td>
                        <td class="px-6 py-4">
                            <label class="relative inline-flex cursor-pointer">
            ...
            <nav class="flex items-center pt-4 py-2 px-2" aria-label="Table navigation">
                <p class="text-xs text-gray-700 dark:text-gray-400 mr-20">
                    Menampilkan: <span class="font-semibold text-gray-900 dark:text-white">1</span> - <span
                        ...
                        class="font-semibold text-gray-900 dark:text-white">100</span> Hasil
                </p>
                <!-- Buttons -->
                <div class="flex ml-10">
                    <!-- Previous Button -->
                    <a href="#"
                        class="flex items-center justify-center px-3 h-8 text-xs font-medium text-gray-500 hover:text-gray-800 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
                        Prev
                    </a>
                    <ul class="inline-flex -space-x-px text-xs">
                        <li>
                            <a href="#"
                                class="flex items-center justify-center px-3 mr-1 h-8 text-grey-600 bg-yellow-500 border border-grey-200 hover:bg-gray-100 hover:text-grey-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white rounded-xl">1</a>
                        </li>
                        <li>
                            <a href="#"
                                class="flex items-center justify-center px-3 mr-1 h-8 text-grey-600 bg-white-50 border border-grey-200 hover:bg-gray-100 hover:text-grey-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white rounded-xl">2</a>
                        </li>
                        <li>
                            <a href="#"
                                class="flex items-center justify-center px-3 mr-1 h-8 text-grey-600 bg-white-50 border border-grey-200 hover:bg-gray-100 hover:text-grey-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white rounded-xl">3</a>
                        </li>
                        <li>
                            <a href="#"
                                class="flex items-center justify-center px-3 mr-1 h-8 text-grey-600 bg-white-50 hover:bg-gray-100 hover:text-grey-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white rounded-xl">...</a>
                        </li>
                        <li>
                            <a href="#"
                                class="flex items-center justify-center px-3 mr-1 h-8 text-grey-600 bg-white-50 border border-grey-200 hover:bg-gray-100 hover:text-grey-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white rounded-xl">10</a>
                        </li>
                    </ul>
                    <!-- Next Button -->
                    <a href="#"
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-6 text-center">
                        <svg width="60" height="60" viewBox="0 0 100 100" fill="none"
                            xmlns="http://www.w3.org/2000/svg"
                            class="mx-auto mb-4 text-gray-400 w-15 h-15 dark:text-gray-200">
                        ...
                        <h3 class="mb-5 text-sm font-normal text-gray-500 dark:text-gray-400">Apakah Anda yakin ingin
                        ...
                        <button data-modal-hide="popup-modal" type="button"
                            class="text-white-50 bg-red-500 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-700 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2">
                            Hapus
                        </button>
                    </div>
                </div>
