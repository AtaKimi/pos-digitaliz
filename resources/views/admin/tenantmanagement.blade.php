    ...
    <div class="p-2 bg-white-50 border border-gray-200 rounded-3xl shadow">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-2xl">
            <table class="w-full text-sm text-left text-gray-500">
                ...
                <tbody>
                    <tr
                        class="bg-white-50 border-b hover:bg-gray-50">
                        <td class="w-4 p-4">
                            <div class="flex items-center">
                                1
                            </div>
                    ...
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <p
                                class="w-30 bg-green-100 text-green-800 text-xs font-medium mr-2 py-0.5 rounded-full text-center">
                                Lunas</p>
                        </td>
                        <td class="px-6 py-4">
                            <label class="relative inline-flex cursor-pointer">
                ...
                <div class="relative bg-white rounded-lg shadow">
                    ...
                    <div class="p-6 text-center">
                        <svg width="60" height="60" viewBox="0 0 100 100" fill="none"
                            xmlns="http://www.w3.org/2000/svg"
                            class="mx-auto mb-4 text-gray-400 w-15 h-15">
