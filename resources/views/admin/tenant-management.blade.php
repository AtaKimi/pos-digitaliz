                        ...
                        <tr class="border-b bg-white-50 hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4">
                                @if ($tenant->payment_status === 'Sudah bayar')
                                    <p
                                        class="w-30 bg-green-200 text-green-800 text-xs font-medium mr-2 py-0.5 rounded-full text-center">
                            ...
                            <td class="px-6 py-4">
                                <label class="relative inline-flex cursor-pointer">
                                    <input type="checkbox" value="" class="sr-only peer toggle-checkbox"
                                        {{ $tenant->is_active ? '' : 'checked' }} data-tenant-id="{{ $tenant->id }}">
